...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $conn->prepare("INSERT INTO studygroup (GroupName, Description, CreatedBy, OriginalCreatorID) VALUES (?, ?, ?, ?)");
    $stmt->bind_param("ssii", $group_name, $description, $created_by, $created_by);
